        ...
        return(
            <div className="aboutme-background">
                ...
                <div className="aboutme-text">
                    <h2 className="title-long">I'm a front-end developer with a passion for photography.</h2>
                    <h2 className="title-short">A <br/>designer <br/>who <br/> codes</h2>
                    <p>I combine my analytical skills and strong attention to detail, honed from a career in data science, with modern development tools and an understanding of UX Design, to build effective, pixel perfect web solutions from start to finish. My experience includes:</p>
                        <ul>
                            ...
                            <li> WordPress and PHP</li>
                            <li> E-commerce: Shopify & WooCommerce</li>
                            <li> Deployment, including hosting & domain name transfer</li>
